...
#else
!$omp target teams distribute parallel do collapse(2) private(i,fybar,dvdx,dvdy,advc,tmp0,tmp1)
#endif
#else
#ifndef USE_GPU
!$omp do private(i, fybar, dvdx, dvdy, advc, tmp0, tmp1, tmp2, tmp3)
#else
!$omp target teams distribute parallel do collapse(2) private(i,fybar,dvdx,dvdy,advc,tmp0,tmp1,tmp2,tmp3)
#endif
#endif
         do j = jst, jnd
            do i = ist, ind
...
#else
!$omp target teams distribute parallel do collapse(2) private(i,zhigh,zlow,discharge,dhigh)
#endif
            do j = jst, jnd
               do i = ist, ind
...
#else
!$omp target teams distribute parallel do collapse(2) private(i,fxbar,dvdx,dvdy,advc,tmp0,tmp1)
#endif
#else
#ifndef USE_GPU
!$omp do private(i, fxbar, dvdx, dvdy, advc, tmp0, tmp1, tmp2, tmp3)
#else
!$omp target teams distribute parallel do collapse(2) private(i,fxbar,dvdx,dvdy,advc,tmp0,tmp1,tmp2,tmp3)
#endif
#endif
         do j = jst, jnd
            do i = ist, ind
